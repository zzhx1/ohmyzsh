...
You may also need to [customize your theme](https://github.com/zzhx1/ohmyzsh/issues/9395#issuecomment-1027130429) 
to change the way the prompt is built. See the
[OMZ wiki on customizing themes](https://github.com/zzhx1/ohmyzsh/wiki/Customization#overriding-and-adding-themes).
