...
setopt prompt_subst
PROMPT='%(?:%{$fg[white]%}$(toon):%{$fg[red]%}$(toon)) %{$fg[cyan]%}[%.% ]%{$reset_color%}${vcs_info_msg_0_}%{$reset_color%}%(?:%{$fg[white]%}»:%{$fg[red]%}») '
# PROMPT='%(?:%{$fg[white]%}$(toon):%{$fg[red]%}$(toon)) %{$fg[cyan]%}[%.% ]%{$reset_color%}${vcs_info_msg_0_}%{$reset_color%}» '
