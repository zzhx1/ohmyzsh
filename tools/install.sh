...
# or via wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/zzhx1/ohmyzsh/master/tools/install.sh)"
# or via fetch:
...
#   REPO    - name of the GitHub repo to install from (default: zzhx1/ohmyzsh)
